...
export default function Kwatera1() {
  return (
    <div className={styles.main}>
      <div className={styles.page_outlet}>
        <h3>1 - Czteroosobowy pokój na pietrze</h3>
        ...
        <div className={styles.room_equipment_info}>
          ...
          <div className={styles.room_equipment_boxs}>
            <RoomPersonIcon />
            <span>Czteroosobowy pokój na piętrze</span>
          </div>
          <div className={styles.room_equipment_boxs}>
            <RoomBedIcon />
            <span>Dwa parterowe łóżka</span>
          </div>
          <div className={styles.room_equipment_boxs}>
            <RoomDoubleBedIcon />
          ...
          {/* <SlickCarousel images={premium1Imgs} /> */}
        </div>
      </div>
    </div>
  );
